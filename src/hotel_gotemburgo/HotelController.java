...
public class HotelController {
	 ...
	 * transacoes. Chama o metodo inicializaTiposDeQuarto para atribuir uma String a
	 * um tipo de quarto. Define o ano atual e também qual a idade que se atinge a
	 * maioridade.
	 */
	 ...
	 * 
	 * @return O atributo restaurante, que representa o RestauranteController do
	 *         Hotel
	 */
	 ...
	 * Caso um dos hospedes possua esse email, o hospede em questao eh retornado.
	 * 
	 * @param email
	 *            Email do hospede buscado
	 * @return Um hospede, caso encontrado
	 * @throws HotelGotemburgoException
	 *             Caso seja identificado algum erro de valor ou caso o Hospede nao
	 *             tenha sido encontrado (ou seja, nao esta cadastrado)
	 */
	...
	/**
	 * Verifica se um hospede esta hospedado no hotel, pela quantidade de estadias
	 * que ele possui (0 = nao esta hospedado)
	 * 
	 * @param email
	 *            Email do hospede que sera verificada a situacao de hospedagem no
	 *            Hotel.
	 ...
	 * verificaco para saber se ja existe um hospede com o email recebido. Caso nao
	 * exista, cria um novo objeto Hospede com os valores recebidos como parametros,
	 * em seguida adiciona-o ao set de hospedes.
	 * 
	 * @param nome
	...
	/**
	 * Retorna informacoes relativas a um hospede (pesquisado atraves do email) de
	 * acordo com o atributo recebido na entrada.
	 * 
	 * @param email
	 *            Email do hospede do qual deseja-se consultar informacoes
	 * @param atributo
	 *            Representa qual informacao a respeito do hospede sera consultada e
	 *            retornada, podendo ser seu/sua: 1)nome 2)data de nascimento
	 *            3)email 4)pontos
	 ...
	 *            consultadas
	 * @param atributo
	 *            Definira qual opcao sera consultada, podendo ser: 1) "Hospedagem
	 *            ativa" - retorna a quantidade de estadias do hospede; 2)"Quarto" -
	 *            retorna uma string com o id dos quartos de suas estadias;
	 *            3)"Total" - retorna os gastos com estadia do hospede
	 * @return Uma String representando a informacao desejada
	 * @throws HotelGotemburgoException
	 *             1)Em caso de parametros invalidos; 2) se o hospede nao estiver
	 *             cadastrado ou hospedado no Hotel; 3) se a opcao escolhida for
	 *             invalida
	 */
	 ...
	 * @param atributo
	 *            Uma string representando qual atributo sera alterado, podendo ser
	 *            "nome, "data de nascimento" ou "email
	 * @param novoValor
	...
	/**
	 * Metodo utilizado no construtor para iniciar o mapa que associa uma String que
	 * representa um Enum de TipoDeQuarto, a uma constante desse Enum. Ex: key-
	 * "SIMPLES" value- TipoDeQuarto.SIMPLES
	 */
	...
	/**
	 * Consulta o mapa de tipos e retorna o valor (constante do Enum) correspondente
	 * a string recebida como parametro, se houver
	 * 
	 * @param tipoQuarto
	 *            String representando o tipo do quarto, que deve ser igual a alguma
	 *            das chaves do mapa de Tipos presente no Controller.
	 * @return constante do Enum TipoDeQuarto
	 * @throws HotelGotemburgoException
	 *             Caso nao exista, no mapa de tipos, uma chave que seja igual ao
	 *             parametro recebido
	 */
	...
	/**
	 * Metodo utilizado para garantir que uma string que supostamente representa um
	 * Tipo de Quarto esta de acordo com o esperado.
	 * 
	 * @param tipo
	...
	/**
	 * Metodo utilizado para verificar se um determinado quarto - que sera buscado
	 * atraves do ID - esta ou nao ocupado.
	 * 
	 * @param idQuarto
	...
	/**
	 * Esse metodo eh responsavel por realizar o checkin de um hospede no Hotel. O
	 * hospede precisa previamente estar cadastrado no sistema, entao ele sera
	...
	/**
	 * Metodo responsavel por realizar o checkout de um hospede no hotel, removendo
	 * a estadia no quarto do qual ele esta saindo, retirando esse quarto do set de
	 * quartos ocupados. Eh criada uma Transacao para registrar essa operacao e em
	 * seguida essa transacao eh registrada no array de transacoes. Tambem eh
	 ...
	 * 
	 * @param atributo
	 *            Representa a informacao desejada sobre as transacoes registradas
	 *            no sistema, podendo ser: "quantidade" - a quantidade de transacoes
	 *            ; "total" - o valor total das transacoes; "nome" - a lista do nome
	 *            dos hospedes que realizaram transacoes.
	...
	/**
	 * Sobrecarga de metodo, que agora recebe um indice referente a posicao de um
	 * Hospede especifico no array de transacoes. As informacoes solicitadas sao
	 * agora "nome" e "total", e se referem apenas ao hospede em questao.
	 * 
	 * @param atributo
	...
	/**
	 * Esse metodo eh responsavel por receber de um hospede um pedido de refeicao.
	 * Uma transacao eh criada para registrar esse pedido e pontos sao adicionados
	 * ao cartao fidelidade do hospede de acordo com o valor dessa compra.
	 * 
	 * @param email
	 *            Email do hospede
	 * @param item
