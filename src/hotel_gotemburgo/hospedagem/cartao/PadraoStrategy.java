...
public class PadraoStrategy implements CartaoFidelidade {
	 ...
	 * Fidelidade; esse construtor inicializa os pontos e a recompensa.
	 */
	 ...
	 * recebe um valor de entrada e retorna a recompensa do determinado hospede.
	 */
	@Override
	...
	/**
	 * Como o hospede possui um cartao padrao, ele nao possui desconto e esse metodo
	 * retorna apenas o valor de entrada.
	 */
	@Override
