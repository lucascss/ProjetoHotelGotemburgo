...
public class Restaurante {
	...
	/**
	 * Realiza o cadastro de uma refeicao ao set de refeicoes do Restaurante. Para
	 * isso, verifica se todos os pratos do array recebido como parametro estao
	 * previamente cadastrados no sistema. Se estiverem, cria uma instancia de
	 * Refeicao e a adiciona no set de refeicoes do restaurante. Adiciona tambem
	 * essa refeicao ao menu.
	 * 
	 * @param nome
	 *            Nome da refeicao
	 * @param descricao
	 ...
	 *            esses nomes para entao poder ser criada uma colecao com os objetos
	 *            Prato correspondentes.
	...
	/**
	 * Esse metodo consulta informacoes de um prato ou refeicao do restaurante. A
	 * informacao que sera retornada eh definida atraves do parametro "atributo".
	 * 
	 * @param nome
